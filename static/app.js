...
async function startQuizGeneration() {
    ...
    commandText.textContent = `bob --hide-intermediary-output --output-format json --chat-mode advanced "[Prompt with 10 excerpts at ${activeDifficulty.toUpperCase()} difficulty]"`
    ...
    try {
        ...
        try {
            ...
            bobCommand = `bob --hide-intermediary-output --output-format json --chat-mode advanced < [static_build_trigger]`;
