...
def build_prompt(selected_chunks: list[dict], difficulty: str) -> str:
    ...
    prompt = (
        f"You are a strict compliance API. Generate exactly 10 onboarding and compliance verification multiple-choice questions (MCQs) in JSON format.\n\n"
        ...
        f"5. Output ONLY a valid JSON array of 10 objects. Do NOT include any markdown blocks (like ```json), do NOT include any introductory or concluding conversational text. Start directly with the character '[' and end with ']'.\n\n"
